...
const StoryCard: React.FC<StoryCardProps> = ({ onClick, coverImage, title }) => {
  ...
  return (
    ...
    <div 
      ...
      className="relative max-w-[250px] h-[330px] bg-[#F7EFCC] border border-[#C7C7C7] rounded-lg cursor-pointer overflow-hidden" 
    ...
    >
      ...
      <img
        ...
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[160px] h-[273px] object-cover z-10"
